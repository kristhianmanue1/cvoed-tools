...
**Session ID**: 04bfe904-6705-4ba2-b427-acaecbdc097f
**Agent ID**: controlador-04bfe904-6705-4ba2-b427-acaecbdc097f
**Timestamp**: 2026-03-11 17:43:23
**Language**: ES
...
**Task**: DIAGNÓSTICO URGENTE: Verificar index.html (no lleva a página principal) y auditar todos los links a componentes. 

ESPECÍFICO:
1. Abrir index.html en navegador y diagnosticar por qué no carga la página principal
2. Verificar estructura HTML: <head>, <base>, <script tags>, rutas relativas/absolutas
3. Identificar si es problema de: ruta incorrecta, archivo faltante (main.js, bundle.js, etc.), o configuración de servidor
4. Auditar TODOS los links a componentes: href, src, data-href, router links
5. Verificar existencia de archivos referenciados: main.js, components/*.js, styles/*.css, assets/*
6. Revisar consola del navegador para errores: 404, CORS, MIME type errors

ENTREGABLES:
- DIAGNOSTICO_INDEX_HTML.md: Análisis completo del problema raíz
- AUDIT_LINKS_COMPONENTES.md: Listado de todos los links verificados (rotos vs funcionales)
- PLAN_FIXES.md: Recomendaciones específicas de corrección paso a paso

CRITERIO ÉXITO: Identificación clara del problema raíz y lista de fixes priorizados (in project: cvoed-tools)
...
```json
{
  ...
  "timestamp": "2026-03-11T17:43:21.861154+00:00",
  ...
  "verified_context": {
    ...
    "semantic_context": [
      [
        {
          "id": "a775d8b1-196b-42ee-a991-b63a66b2cf1d",
          ...
          "created_at": "2026-03-11T17:43:16.679297+00:00"
        },
        0.5664621133495105
      ],
      [
        {
          "id": "00dc8e25-5b22-4953-8eda-f2c8e9f86580",
          ...
          "is_contested": false,
          "verification_count": 0,
          "created_at": "2026-03-11T17:43:16.679380+00:00"
        },
        0.5592245767920755
      ],
      [
        {
          "id": "55d9dd7c-e93e-44da-9152-67d8d6132cc6",
          ...
          "is_contested": false,
          "verification_count": 0,
          "created_at": "2026-03-11T17:43:16.679419+00:00"
        },
        0.5564338992930956
      ],
      [
        {
          "id": "1b77c2e2-61bc-4e81-817d-fabdb168746a",
          ...
          "is_contested": false,
          "verification_count": 0,
          "created_at": "2026-03-11T17:43:16.679460+00:00"
        },
        0.5501088727415234
      ]
    ],
    ...
    "failed_gate": null,
    "error_message": null,
    "verified_at": "2026-03-11T17:43:16.679803+00:00"
  },
  "blocking": true,
  "cli_mode": true,
...
System state initialized. Begin your assigned mission immediately.' --session-id a36ecc34-4b5c-59dd-98c9-770d9e441734 'System state initialized. Begin your assigned mission immediately.'
